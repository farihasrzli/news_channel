...
<!--market updates updates-->
   <div class="market-updates">
      <a href="admin_post.php"><div class="col-md-4 market-update-gd">
      ...
      <a href="admin_statistics.php"><div class="col-md-4 market-update-gd">
      ...
      <a href="index.php"><div class="col-md-4 market-update-gd">
  ...
  <div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  COVID-19 Current Situation in Malaysia
                            </div>
                            <div class="table-responsive">
                              ...
                              <tr>
                                  <td></td>
                                  <td></td>
                                  <td><button type="button" onclick="alert('Check It Here')">See More!</button></td>                                  
      ...
      <div class="col-md-6 chit-chat-layer1-rit">     
        ...
        <div class="wrapper-flex">
            ...
            <div class="col geo_main">
                 <h3 id="geoChartTitle">World Map</h3>
