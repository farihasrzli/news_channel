...
<div class="inner-block">
	<div><h2>All News of COVID-19 in Malaysia :</h2></div>
    <div class="chart-main-block">
      ...
      <div class="row">
             ...
             <iframe id="yourframeid" name="yourframename" src="NEWS-BUZZ/admin/posts.php"; style="width:100%; height:120vh;"></iframe>
...
<table width="100%">
	<tr>
		...
		<td>
		<a href="about.php"><div class="col-md-4 market-update-gd">
